#import all the files from Race_files
from Race_files import Aasimar_Race, Dragonborn_Race, Dwarf_Race, Elf_Race, Goliath_Race, Half_Orc_Race, Human_Race, Tiefling_Race,Kenku_Race

#Assign race strings in dictionary to race files
